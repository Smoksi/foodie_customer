              ...
              : MyAppState.selectedPosotion.location == null ||
                  ...
                  ? Center(
                      child: showEmptyState("We don't have your location.".tr(), context,
                          description: "Set your location to started searching for restaurants in your area".tr(), action: () async {
                        checkPermission(
                          () async {
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        focusedBorder: OutlineInputBorder(
                                            borderRadius: BorderRadius.circular(30.0), borderSide: BorderSide(color: Color(COLOR_PRIMARY), width: 2.0)),
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Text("Our Categories",
                                            style: TextStyle(
                                                color: isDarkMode(context) ? Colors.white : const Color(0xFF000000), fontFamily: "Poppinsm", fontSize: 18)),
                                        GestureDetector(
                                          onTap: () {
                                            push(
                                              context,
